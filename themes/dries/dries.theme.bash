...
# # Git status prompts
GIT_THEME_PROMPT_DIRTY=" ${red}✗${yellow}"
GIT_THEME_PROMPT_CLEAN=" ${green}✓${yellow}"
...
#     PS1="\n${icon_start} ${white}\t${red} | $(virtualenv_prompt)${white}\u${red} | ${blue}\w${red} | ${yellow}$(scm_prompt_info)${normal}\n${icon_end}${red}\$ ${green}"
#     PS2="${normal}${icon_end}"
# }
...
PROMPT_END_CLEAN="${white}└❯${red} \$${reset_color}"
PROMPT_END_DIRTY="${white}└❯${red} \$${reset_color}"
...
prompt_setter() {
  ...
  history -c
  history -r
  PS1="${white}┌${normal} $(clock_prompt) [${blue}\u${reset_color}] ${green}\w${yellow}$(scm_prompt_info) ${reset_color}\n$(prompt_end) "
  PS2='> '
  PS4='+ '
}
...
SCM_THEME_PROMPT_DIRTY=" ${bold_red}✗${yellow}"
SCM_THEME_PROMPT_CLEAN=" ${bold_green}✓${yellow}"
SCM_THEME_PROMPT_PREFIX=" ("
SCM_THEME_PROMPT_SUFFIX=")"
